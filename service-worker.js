...
const ASSETS = ['./', './index.html', './styles.css', './src/main.js?v=60', './src/game.js', './src/audio.js', './src/config.js', './src/systems.js', './src/meta.js', './assets/audio/menu.mp3', './assets/audio/stage.mp3', './assets/audio/boss-warning.mp3', './assets/audio/boss.mp3', './manifest.webmanifest', ...ICON_NAMES.map(name => `./assets/icons/${name}.webp`), ...SVG_ICONS.map(name => `./assets/icons/${name}.svg`), ...AIRCRAFT_NAMES.map(name => `./assets/aircraft/${name}.webp`), ...PILOT_NAMES.map(name => `./assets/pilots/${name}.webp`), ...['upper-left','upper-right','mid-left','mid-right','lower-left','lower-right'].map(name => `./assets/scenes/neon-outskirts/${name}.webp`)];
