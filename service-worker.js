const CACHE = 'raiden-void-circuit-v32';
...
const ASSETS = ['./', './index.html', './styles.css', './src/main.js?v=32', './src/game.js', './src/config.js', './src/systems.js', './src/meta.js', './manifest.webmanifest', ...ICON_NAMES.map(name => `./assets/icons/${name}.webp`), ...SVG_ICONS.map(name => `./assets/icons/${name}.svg`), ...AIRCRAFT_NAMES.map(name => `./assets/aircraft/${name}.webp`), ...PILOT_NAMES.map(name => `./assets/pilots/${name}.webp`)];
