...
export const AIRCRAFT = {
  ...
  lancer: { id: 'lancer', name: 'LANCER', subtitle: '貫通雷射機', art: 'assets/aircraft/lancer.webp', color: '#42e8ff', speed: 5.1, hp: 4, secondaryBoost: .1, primary: 'laser', mastery: '連鎖電擊', description: '連續貫通射線；副武器傷害 +10%；滿級後命中觸發 3 次連鎖電擊，每次造成主體單次傷害的 192%。' },
...
export const FUSIONS = {
  ...
  clusterStars: { id: 'clusterStars', icon: 'assets/icons/cluster-stars.svg', name: '群星', category: 'fusion', set: 'standard', requires: ['bombard', 'prism'], description: '每 1.5 秒鎖定多個目標，朝各目標方向發射一發高速直線貫通射線。' },
  ...
  sixMeridians: { id: 'sixMeridians', icon: 'assets/icons/flying-dragon-force.svg', name: '飛龍勁', category: 'fusion', set: 'kungfu', requires: ['fajin', 'cloudHand'], description: '瞄準最遠的最多五名敵人射出長距離貫通光束；近距離傷害較高。' },
