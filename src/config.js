...
export const SECONDARIES = {
  homing: { id: 'homing', name: '追蹤飛彈', max: 5, color: '#ffb703', description: '鎖定單一目標；目標死亡後停止導引。' },
  drone: { id: 'drone', name: '軌道無人機', max: 5, color: '#8b5cf6', description: '環繞機體並定期射擊。' },
  chain: { id: 'chain', name: '連鎖電弧', max: 5, color: '#67e8f9', description: '定時對附近敵人造成跳躍電擊。' },
  mines: { id: 'mines', name: '磁暴地雷', max: 5, color: '#fb7185', description: '在後方留下延遲爆炸地雷。' },
  rail: { id: 'rail', name: '磁軌爆發', max: 5, color: '#f8fafc', description: '定時發射高傷害貫通彈。' },
  bombard: { id: 'bombard', name: '轟炸莢艙', max: 5, color: '#fb923c', description: '標記敵群位置後進行範圍轟炸。' },
};

export const PASSIVES = {
  magnet: { id: 'magnet', name: '磁力核心', max: 5, description: '增加經驗吸附範圍與速度。' },
  overclock: { id: 'overclock', name: '超頻模組', max: 5, description: '提高射速。' },
  armor: { id: 'armor', name: '反應裝甲', max: 5, description: '提升最大生命與受傷無敵時間。' },
  critical: { id: 'critical', name: '暴擊矩陣', max: 5, description: '增加暴擊機率與傷害。' },
  salvage: { id: 'salvage', name: '戰場回收', max: 5, description: '提升補給與治療機率。' },
  guidance: { id: 'guidance', name: '導引電腦', max: 5, description: '提升追蹤轉向；滿級允許一次重新鎖定。' },
  bombcap: { id: 'bombcap', name: '炸彈電容', max: 5, description: '增加炸彈上限與爆炸傷害。' },
  engine: { id: 'engine', name: '引擎調校', max: 5, description: '提升移動速度。' },
};
