...
export const AIRCRAFT = {
  ...
  lancer: { id: 'lancer', name: 'LANCER', subtitle: '貫通雷射機', art: 'assets/aircraft/lancer.webp', color: '#42e8ff', speed: 5.1, hp: 4, secondaryBoost: .1, primary: 'laser', mastery: '連鎖電擊', description: '連續貫通射線；副武器傷害 +10%；滿級後命中觸發 3 次連鎖電擊，可重複命中同一目標。' },
...
export const KUNGFU_SECONDARIES = {
  ...
  cloudHand: { id: 'cloudHand', icon: 'assets/icons/cloud-hand.svg', name: '穿雲手', max: 3, color: '#38bdf8', description: '瞄準最遠敵人，射出低傷害的長距離貫通光束；升級後縮短射擊間隔。' },
};
...
export const PASSIVES = {
  ...
  siege: { id: 'siege', icon: 'assets/icons/siege-protocol.svg', name: '攻城協定', max: 3, description: '對正式 BOSS 傷害提高 15%／20%／25%；不影響中型首領與召喚物。' },
...
export const FUSIONS = {
  ...
  sixMeridians: { id: 'sixMeridians', icon: 'assets/icons/six-meridians.svg', name: '六脈神劍', category: 'fusion', set: 'kungfu', requires: ['fajin', 'cloudHand'], description: '每 4 秒瞄準最遠的最多五名敵人射出長距離貫通光束；近距離傷害較高。' },
