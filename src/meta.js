...
export const META_UPGRADES = {
  firepower: { id: 'firepower', name: '火力校準', icon: 'assets/icons/primary-cannon.webp', max: 10, costs: [100, 200, 400, 800, 1500, 2500, 4000, 7000, 12000, 20000], describe: rank => `主武器傷害 ${Math.round(metaAttackMultiplier(rank) * 100)}%` },
  ...
  xpGain: { id: 'xpGain', name: '經驗增幅', icon: '✦', max: 3, costs: [500, 2000, 5000], describe: rank => `經驗獲取 ${Math.round(metaXpMultiplier(rank) * 100)}%` },
};
